...
-   `rate_of_change()` - is the estimate of the current instantaneous
    ...
    solutes and hydrograph limbs. This function estimates
    \$\\frac{\\delta Q}{\delta T}\$ on the raw data or predicts the
    first derivative of the fitted spline between date and discharge.
